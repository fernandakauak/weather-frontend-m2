$(document).ready(function () {
    ...
    detallesClimaCiudad.innerHTML += `
        <h1 class="detalle__title text-center">Pronóstico de la semana: ${lugarDatos.nombre}</h1>

        <div class="col-sm-12 col-md-4 text-center mt-3 mb-3 detalle__info">
            <h2 class="detalle__title">Clima</h2>
            <div class="detalle__ico">${lugarDatos.ico}</div>
            <h3>${lugarDatos.clima}</h3>
        </div>

        <div class="col-sm-12 col-md-4 text-center mb-3 detalle__info">
            <h2>Humedad</h2>
            <div class="detalle__ico">💧</div>
